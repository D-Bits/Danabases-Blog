...
In the top of that file, you would then modify the `theme` variable to be equal to "hugo-notepadium", and (optionally) set `style` to "dark", if you want a dark version of the theme.
